...
class GameResultServiceTests {
    ...
    fun test_getLeaderboard_rankTooBig_throwsException() {
        assertThrows<ResponseStatusException> {
            // Service ist leer, Platz 1 gibt es nicht → wirft Fehler.
    ...
    fun test_getLeaderboard_atStart_rank1() {
        ...
        // Erwartet: Rang 1, 2, 3, 4 (targetIndex + 4).
        assertEquals(4, res.size)
        // Startet bei Index 0.
        assertEquals(0, service.getGameResults().indexOf(res[0]))
    }
    ...
    fun test_getLeaderboard_atEnd() {
        ...
        // Erwartet: Rang 2, 3, 4, 5 (targetIndex - 3).
        assertEquals(4, res.size)
        // Endet beim letzten Element.
        assertEquals(4, service.getGameResults().indexOf(res.last()))
    }
}